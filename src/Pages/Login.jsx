...
import { loginapi } from "../api/config.js";
import Freelancer from "./Freelancer";

function Login() {
    const { loginStatus, userLogin, loggedInUser, setToken, token } =
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            let result = await loginapi.post("", formData);
            ...
            console.log(`logged in as ${type} with ${token}`);
        } catch (err) {
            alert(err);
        }
    };
